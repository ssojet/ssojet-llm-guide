...
List prerequisites tailored to $ASP.NET Core, including:  
- An existing $ASP.NET Core application with a login page.  
- Basic knowledge of $ASP.NET Core and its common tools/frameworks (e.g., ${FRAMEWORK_TOOLS}).  
...
- Required libraries or packages specific to $ASP.NET Core for OIDC (e.g., "oidc-client-ts" for JavaScript, "passport-openidconnect" for Node.js, "goth" for Golang).  
...
3. Create a new application (e.g., "My$ASP.NET CoreApp", type **Regular Web App**).  
4. Configure the callback URI (e.g., '$/signin-oidc' specific to $ASP.NET Core, like 'http://localhost:3000/auth/callback' for Node.js).  
...
#### Step 3.2: Modify the Existing $ASP.NET Core Project  

##### Substep 3.2.1: Install Dependencies  
- Specify the OIDC library installation command for $ASP.NET Core (e.g., 'npm install' for Node.js, 'go get' for Golang, 'dotnet add package' for .NET).  
...
- Provide a code snippet to configure the OIDC provider with SSOJet credentials:
  ...
  - **Callback URL**: $/signin-oidc
  - **Scopes**: openid profile email
- Tailor to $ASP.NET Core conventions (e.g., **Passport** for Node.js, **OpenIdConnect middleware** for .NET, **Goth** for Golang).  
...
- Use $ASP.NET Core-specific templating or UI logic (e.g., **EJS** for Node.js, **Razor** for .NET, **html/template** for Golang).  
...
- Provide code snippets specific to $ASP.NET Core (e.g., **Express routes** for Node.js, **Razor Page handlers** for .NET, **Mux handlers** for Golang).  
...
List considerations tailored to $ASP.NET Core:  
...
- Link to relevant $ASP.NET Core-specific OIDC library docs (e.g., **Passport for Node.js**, **Goth for Golang**).  

---

## Customization Instructions  
- Replace '$ASP.NET Core' with the target language (e.g., **Node.js**, **ASP.NET Core**, **Golang**).  
- Replace '${FRAMEWORK_TOOLS}' with common tools (e.g., **Express** for Node.js, **Razor Pages** for .NET, **Gorilla Mux** for Golang).  
- Replace '$/signin-oidc' with a language-appropriate callback (e.g., '/auth/callback', '/signin-oidc').  
