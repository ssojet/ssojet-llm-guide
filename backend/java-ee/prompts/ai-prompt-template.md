...
List prerequisites tailored to $Java, including:  
- An existing $Java application with a login page.  
- Basic knowledge of $Java and its common tools/frameworks (e.g., ${FRAMEWORK_TOOLS}).  
...
- Required libraries or packages specific to $Java for OIDC (e.g., "oidc-client-ts" for JavaScript, "passport-openidconnect" for Node.js, "goth" for Golang).  
...
3. Create a new application (e.g., "My$JavaApp", type **Regular Web App**).  
4. Configure the callback URI (e.g., '$/login/oauth2/code/ssojet' specific to $Java, like 'http://localhost:3000/auth/callback' for Node.js).  
...
#### Step 3.2: Modify the Existing $Java Project  

##### Substep 3.2.1: Install Dependencies  
- Specify the OIDC library installation command for $Java (e.g., 'npm install' for Node.js, 'go get' for Golang, 'dotnet add package' for .NET).  
...
- Tailor to $Java conventions (e.g., **Passport** for Node.js, **OpenIdConnect middleware** for .NET, **Goth** for Golang).  
...
- Use $Java-specific templating or UI logic (e.g., **EJS** for Node.js, **Razor** for .NET, **html/template** for Golang).  
...
- Provide code snippets specific to $Java (e.g., **Express routes** for Node.js, **Razor Page handlers** for .NET, **Mux handlers** for Golang).  
...
List considerations tailored to $Java:  
...
- Link to relevant $Java-specific OIDC library docs (e.g., **Passport for Node.js**, **Goth for Golang**).  

---

## Customization Instructions  
- Replace '$Java' with the target language (e.g., **Node.js**, **ASP.NET Core**, **Golang**).  
