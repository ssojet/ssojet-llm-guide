...
List prerequisites tailored to $Spring Boot, including:  
- An existing $Spring Boot application with a login page.  
- Basic knowledge of $Spring Boot and its common tools/frameworks (e.g., ${FRAMEWORK_TOOLS}).  
...
- Required libraries or packages specific to $Spring Boot for OIDC (e.g., "oidc-client-ts" for JavaScript, "passport-openidconnect" for Node.js, "goth" for Golang).  
...
3. Create a new application (e.g., "My$Spring BootApp", type **Regular Web App**).  
4. Configure the callback URI (e.g., '$/login/oauth2/code/ssojet' specific to $Spring Boot, like 'http://localhost:3000/auth/callback' for Node.js).  
...
#### Step 3.2: Modify the Existing $Spring Boot Project  

##### Substep 3.2.1: Install Dependencies  
- Specify the OIDC library installation command for $Spring Boot (e.g., 'npm install' for Node.js, 'go get' for Golang, 'dotnet add package' for .NET).  
...
- Provide a code snippet to configure the OIDC provider with SSOJet credentials:
  ...
  - **Callback URL**: $/login/oauth2/code/ssojet
  - **Scopes**: openid profile email
- Tailor to $Spring Boot conventions (e.g., **Passport** for Node.js, **OpenIdConnect middleware** for .NET, **Goth** for Golang).  
...
- Use $Spring Boot-specific templating or UI logic (e.g., **EJS** for Node.js, **Razor** for .NET, **html/template** for Golang).  
...
- Provide code snippets specific to $Spring Boot (e.g., **Express routes** for Node.js, **Razor Page handlers** for .NET, **Mux handlers** for Golang).  
...
List considerations tailored to $Spring Boot:  
...
- Link to relevant $Spring Boot-specific OIDC library docs (e.g., **Passport for Node.js**, **Goth for Golang**).  

---

## Customization Instructions  
- Replace '$Spring Boot' with the target language (e.g., **Node.js**, **ASP.NET Core**, **Golang**).  
- Replace '${FRAMEWORK_TOOLS}' with common tools (e.g., **Express** for Node.js, **Razor Pages** for .NET, **Gorilla Mux** for Golang).  
- Replace '$/login/oauth2/code/ssojet' with a language-appropriate callback (e.g., '/auth/callback', '/signin-oidc').  
