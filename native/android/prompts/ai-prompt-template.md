...
List prerequisites tailored to $Android/Kotlin, including:  
- An existing $Android/Kotlin application with a login page.  
- Basic knowledge of $Android/Kotlin and its common tools/frameworks (e.g., ${FRAMEWORK_TOOLS}).  
...
- Required libraries or packages specific to $Android/Kotlin for OIDC (e.g., "oidc-client-ts" for JavaScript, "passport-openidconnect" for Node.js, "goth" for Golang).  
...
3. Create a new application (e.g., "My$Android/KotlinApp", type **Regular Web App**).  
4. Configure the callback URI (e.g., '$com.ssojet.app:/oauth2callback' specific to $Android/Kotlin, like 'http://localhost:3000/auth/callback' for Node.js).  
...
#### Step 3.2: Modify the Existing $Android/Kotlin Project  

##### Substep 3.2.1: Install Dependencies  
- Specify the OIDC library installation command for $Android/Kotlin (e.g., 'npm install' for Node.js, 'go get' for Golang, 'dotnet add package' for .NET).  
...
- Provide a code snippet to configure the OIDC provider with SSOJet credentials:
  ...
  - **Callback URL**: $com.ssojet.app:/oauth2callback
  - **Scopes**: openid profile email
- Tailor to $Android/Kotlin conventions (e.g., **Passport** for Node.js, **OpenIdConnect middleware** for .NET, **Goth** for Golang).  
...
- Use $Android/Kotlin-specific templating or UI logic (e.g., **EJS** for Node.js, **Razor** for .NET, **html/template** for Golang).  
...
- Provide code snippets specific to $Android/Kotlin (e.g., **Express routes** for Node.js, **Razor Page handlers** for .NET, **Mux handlers** for Golang).  
...
List considerations tailored to $Android/Kotlin:  
...
- Link to relevant $Android/Kotlin-specific OIDC library docs (e.g., **Passport for Node.js**, **Goth for Golang**).  

---

## Customization Instructions  
- Replace '$Android/Kotlin' with the target language (e.g., **Node.js**, **ASP.NET Core**, **Golang**).  
- Replace '${FRAMEWORK_TOOLS}' with common tools (e.g., **Express** for Node.js, **Razor Pages** for .NET, **Gorilla Mux** for Golang).  
- Replace '$com.ssojet.app:/oauth2callback' with a language-appropriate callback (e.g., '/auth/callback', '/signin-oidc').  
