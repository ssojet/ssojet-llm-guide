# AI Prompt Template for SSOJet Next.js Integration Guide
...
List prerequisites tailored to $NextJS, including:  
- An existing $NextJS application with a login page.  
- Basic knowledge of $NextJS and its common tools/frameworks (e.g., ${FRAMEWORK_TOOLS}).  
...
- Required libraries or packages specific to $NextJS for OIDC (e.g., "oidc-client-ts" for JavaScript, "passport-openidconnect" for Node.js, "goth" for Golang).
...
3. Create a new application (e.g., "My$NextJSApp", type **Regular Web App**).  
4. Configure the callback URI (e.g., '$/auth/callback' specific to $NextJS, like 'http://localhost:3000/auth/callback' for Node.js).  
...
#### Step 3.2: Modify the Existing $NextJS Project  

##### Substep 3.2.1: Install Dependencies  
- Specify the OIDC library installation command for $NextJS (e.g., 'npm install' for Node.js, 'go get' for Golang, 'dotnet add package' for .NET).  
...
- Tailor to $NextJS conventions (e.g., **Passport** for Node.js, **OpenIdConnect middleware** for .NET, **Goth** for Golang).  
...
- Use $NextJS-specific templating or UI logic (e.g., **Next.js components** for Next.js, **EJS** for Node.js, **Razor** for .NET, **html/template** for Golang).  
...
List considerations tailored to $NextJS:  
...
- Link to relevant $NextJS-specific OIDC library docs (e.g., **Passport for Node.js**, **Goth for Golang**).

---

## Customization Instructions  
- Replace '$NextJS' with the target language (e.g., **Node.js**, **ASP.NET Core**, **Golang**).  
